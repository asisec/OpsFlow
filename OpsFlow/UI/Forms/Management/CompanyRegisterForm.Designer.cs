namespace OpsFlow.UI.Forms.Management
{
    partial class CompanyRegisterForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtTaxNumber = new Guna.UI2.WinForms.Guna2TextBox();
            txtAddress = new Guna.UI2.WinForms.Guna2TextBox();
            btnSaveCompany = new Guna.UI2.WinForms.Guna2Button();
            label2 = new Label();
            label3 = new Label();
            label4 = new Label();
            label5 = new Label();
            ...
            label1.TabIndex = 1;
            label1.Text = "Şirket Kayıt Formu";
            // 
            // txtPhone
            // 
            ...
            txtPhone.Location = new Point(305, 163);
            ...
            txtTaxNumber.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
            txtTaxNumber.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
            txtTaxNumber.FillColor = Color.FromArgb(26, 31, 46);
            txtTaxNumber.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
            txtTaxNumber.Font = new Font("Poppins", 9F, FontStyle.Regular, GraphicsUnit.Point, 162);
            txtTaxNumber.ForeColor = Color.White;
            txtTaxNumber.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
            txtTaxNumber.Location = new Point(305, 237);
            txtTaxNumber.Margin = new Padding(3, 5, 3, 5);
            ...
            txtAddress.FillColor = Color.FromArgb(26, 31, 46);
            txtAddress.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
            txtAddress.Font = new Font("Poppins", 9F, FontStyle.Regular, GraphicsUnit.Point, 162);
            txtAddress.ForeColor = Color.White;
            txtAddress.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
            txtAddress.Location = new Point(305, 317);
            ...
            label5.Location = new Point(305, 209);
            label5.Name = "label5";
        ...
        private Guna.UI2.WinForms.Guna2Button btnSaveCompany;
